CREATE OR REPLACE FUNCTION public.fn_export_regulatory_report(p_report_type VARCHAR)
RETURNS JSONB
LANGUAGE plpgsql
SECURITY DEFINER
...
BEGIN
    ...
    IF v_caller_role NOT IN ('super_admin', 'fleet_manager', 'account_owner') THEN
        RAISE EXCEPTION 'JURISDICCIÓN DENEGADA: Solo gerencia y dueños de cuenta pueden generar paquetes de auditoría legal.'
            USING ERRCODE = '42501';
    END IF;
    ...
    -- Inyección Forense para Auditoría WHS LOTO
