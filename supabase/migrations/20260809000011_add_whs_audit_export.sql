CREATE OR REPLACE FUNCTION public.fn_export_regulatory_report(
    p_report_type VARCHAR(30) -- 'ATO_FUEL_REBATE', 'WHS_FATIGUE_AUDIT', 'PREDICTIVE_MAINTENANCE', 'WHS_BREAK_GLASS_AUDIT'
)
RETURNS JSONB
LANGUAGE plpgsql
SECURITY DEFINER
...
BEGIN
    ...
    -- [NUEVO] Inyección Forense para Auditoría WHS LOTO
